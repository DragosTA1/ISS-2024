...
public class Service implements IService, Observable {
    ...
    public Service(IAdminRepo adminRepo, ISpectatorRepo spectatorRepo, PerformanceRepo performanceRepo, SeatCategoryRepo seatCategoryRepo, ReservationRepo reservationRepo, SeatRepo seatRepo, IRepository<Long, SeatReserved> seatReservedRepo) {
